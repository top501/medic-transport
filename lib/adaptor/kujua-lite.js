...
console.log('POLL RESULTS: ' + JSON.stringify(_poll_results));
  ...
  _perform_http_callbacks: function (_callback_object, _depth, _callback) {
    ...
    http_request(request, function (_err, _resp, _body) {
      ...
      if (!next_callback_object) {
        ...
        self._forget_previously_sent_uuids(body);
  ...
  */
 _forget_previously_sent_uuids: function (_response_body) {

   this._debug_print(
     '_forget_previously_sent_uuids: ' + JSON.stringify(_response_body)
   );
 },
