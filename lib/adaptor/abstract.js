...
exports.prototype = {
  ...
  /**
  * @name get_default_country_code:
  *  Transport uses the default country code to compare phone numbers that
  *  lack a country code. It will query the adapter to see if the user has
  *  set one.
  */
  get_default_country_code: function (callback) {
    return callback(null);
  },

  /**
  * @name get_configuration:
  *  Invokes _callback(_err, _config).
  *  Config is a JSON object containing two keys: 'router' and 'drivers', each
  *  containing their respective configurations.
  */
