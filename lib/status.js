...
exports.prototype = {
  ...
  */
  ...
  /**
  * @name _parse_phone_number:
  *   Using libphonenumber, this returns the formatted number. If no
  *   international code is provided in the number, the default country code is
  *   used.
  */
  ...
  */
  ...
  /**
  * @name check_message_is_from_driver:
  *   Checks if the message is from the driver by comparing the phone numbers
  *   using _parse_phone_number.
  */
