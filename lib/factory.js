...
exports.create_config_from_file = function(file_name) {
  return require("./config/" + file_name);
}

exports.create_from_config = function (config) {
  var t = transport.create(config.transport)
  t.load_adaptor(config.adaptor.name, config.adaptor);
  return t;
}
